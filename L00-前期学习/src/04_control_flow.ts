...
// 故意演示 fall-through bug：case 200 忘了 return/break，会穿透到 case 404
function fallThroughBug(statusCode: number): string {
  let result = 'Unknown';
  switch (statusCode) {
    case 200:
      result = 'OK';
...
// 演示效果：
// fallThroughBug(200) → "Not Found" ❌ 预期是 "OK"，因为穿透把 result 覆盖了
// fallThroughBug(404) → "Not Found" ✅
// fallThroughBug(500) → "Server Error" ✅
